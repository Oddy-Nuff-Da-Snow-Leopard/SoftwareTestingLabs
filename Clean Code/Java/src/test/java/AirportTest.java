...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        assertTrue(isAllTransport);
    }

    @Test
    public void testGetPassengerPlaneWithMaxPassengerCapacity() {
        Airport airport = new Airport(PLANES);
        assertTrue(airport.getPassengerPlaneWithMaxPassengerCapacity()
                .equals(PLANE_WITH_MAX_PASSENGER_CAPACITY));
    }
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        assertTrue(isPreviousPlaneMaxLoadCapacityLessThanCurrent);
    }
    ...
    public void testHasNoUnclassifiedPlaneInExperimentalPlanes() {
        ...
        assertFalse(hasUnclassifiedPlane);
    }
}
